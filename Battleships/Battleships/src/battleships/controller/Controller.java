...
/*		try {
			...
			alert.setContentText("Problem with server connection!");
			alert.showAndWait();
		}
    ...
    /**
     *  Method that is creating listeners on player's game board, allows interaction with game board during ship placement
     * @param board
     */
   ...
   /**
    * Method that is creating listeners on opponent's game board, allows interaction with game board during guessing phase of the game
    * @param board
    */
...
/*    public void generateRandom() {
    ...
    /**
     * Simple AI to play with, chooses a random tile on player game board
     */
    ...
    /**
     * Method used to check the game state and declare the winner
     */
